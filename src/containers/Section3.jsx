...
const Section3 = () => {
  ...
  const handleClick = () => {
    ...
    const newPath =
      '/config/' + (lang === null || lang === 'eu' ? '' : `?lang=${lang}`);
    navigate(newPath);
  };
  ...
  return (
    <div className="section h-full space-y-12">
      <AnimatedText
        className="max-w-250 text-2xl md:text-3xl lg:text-4xl font-aboreto text-left"
        text={getTranslation(language, 'section3.title')}
      />
      <div className="w-full h-max flex flex-col lg:flex-row items-end justify-between gap-4">
        <div className="w-full h-[40vh] flex gap-4 items-end">
          <Image
            src="/assets/sec3-img1.webp"
            alt="img"
            className="lg:h-[90%]"
            imgClassName="object-top"
          />
          <Image
            src="/assets/sec2-img2.webp"
            alt="img"
            className="w-[45%] h-[60%] lg:h-[50%]"
            imgClassName="object-top"
          />
        </div>
        ...
        <div className="w-full h-[40vh] lg:h-[50vh] flex items-start lg:items-end gap-4">
          <div className="w-[60%]" ref={buttonRef}>
            <PrimaryButton
              text={getTranslation(language, 'section3.cta')}
              variant={'outlined'}
