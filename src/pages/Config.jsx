...
import { openEmail, openShare, takeScreenshot } from "@/lib/utils"
			...
			{!isFullScreen &&
				<div className="flex-1 max-w-screen-md h-full p-5 flex flex-col gap-y-3 overflow-y-auto z-10">
					<div className="flex items-center justify-between">
						...
						<PrimaryButton text='Contact' startIcon={MailIcon} onClick={openEmail} isResponsive className={'lg:px-7 py-2.5'} />
						<div className="w-full flex justify-end gap-x-5 lg:hidden">
							<PrimaryButton text='Share' startIcon={Share2} onClick={openShare} isResponsive className={'lg:px-7 py-2.5'} variant={'outlined'} />
							<PrimaryButton text='Download' startIcon={Download} onClick={takeScreenshot} isResponsive className={'lg:px-7 py-2.5'} variant={'outlined'} />
						</div>
					</div>
