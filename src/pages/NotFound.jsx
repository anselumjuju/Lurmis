	...
	return (
		<div className="w-full h-dvh py-[5%]  flex items-center justify-between flex-col space-y-7">
			...
			<div className="space-y-5 flex-1 flex flex-col justify-center text-center">
				...
				<p className="w-2/3 mx-auto text-md text-neutral-500">Oops! The page you're looking for doesn't exist. Check the URL or return to the homepage.</p>
				<div className="h-10" />
				<PrimaryButton text={"Back to Home"} onClick={() => { window.location.href = "/" }} variant={"outlined"} className={'mx-auto'} />
			</div>
		</div>
	)
}
